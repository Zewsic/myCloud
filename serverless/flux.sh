...
HF_MODELS=(
  "https://huggingface.co/black-forest-labs/FLUX.2-klein-9b-fp8/resolve/main/flux-2-klein-9b-fp8.safetensors|${MODELS_DIR}/checkpoints/flux-2-klein-9b-fp8.safetensors"

  "https://huggingface.co/Comfy-Org/vae-text-encorder-for-flux-klein-9b/resolve/main/split_files/text_encoders/qwen_3_8b_fp8mixed.safetensors|${MODELS_DIR}/text_encoders/qwen_3_8b_fp8mixed.safetensors"
  ...
  "https://huggingface.co/Comfy-Org/vae-text-encorder-for-flux-klein-9b/resolve/main/split_files/vae/flux2-vae.safetensors|${MODELS_DIR}/vae/flux2-vae.safetensors"

  "https://huggingface.co/Comfy-Org/flux1-kontext-dev_ComfyUI/resolve/main/split_files/diffusion_models/flux1-dev-kontext_fp8_scaled.safetensors|${MODELS_DIR}/diffusion_models/flux1-dev-kontext_fp8_scaled.safetensors"
